...
Validation: The new regression reproduced the exact 17 OAuth array warnings without the patch, then passed with it. TypeScript and all 31 tests pass. Release verification pending.
